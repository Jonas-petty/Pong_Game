...
class GameManager:
    ...
    def draw_score(self):
        ...
        player_score_rect = player_score.get_rect(midleft=(screen_width/2 + 20, screen_height/2 - 15))
        opponent_score_rect = opponent_score.get_rect(midleft=(screen_width/2 - 40, screen_height/2 - 15))
